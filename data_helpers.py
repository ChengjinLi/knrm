...
def get_config_args():
    ...
    parser.add_argument('--vocabulary-size', type=int, default=3000000, help='Size of vocabulary')
    ...
    parser.add_argument('--use-exact', action='store_true', default=True, help='use exact')
    parser.add_argument('--num-filters', type=int, default=128, help='number of ngram cnn filters')
    parser.add_argument('--cross', action='store_true', default=True, help='use cross')
    parser.add_argument('--max-ngram', type=int, default=2, help='max ngrams')
